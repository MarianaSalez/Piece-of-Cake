...
const getAllRecipes=async function() {
    const recepies = await axios(`https://api.spoonacular.com/recipes/complexSearch?apiKey=${API_KEY_ALL2}&addRecipeInformation=true&number=100`)
...
async function getDiets() {
    const recepies = await axios(`https://api.spoonacular.com/recipes/complexSearch?apiKey=${API_KEY_DIET2}&addRecipeInformation=true&number=100`)
   if (recepies.data.results) {
